...
namespace Platformer2D
{
    ...
    class Player
    {
        ...
        public void LoadContent()
        {
            ...
            redHitBox = Level.Content.Load<Texture2D>("Test/redHitBox");
        ...
        public void attackingEnemy(Enemy enemy)
        {
            hitbox = new Rectangle((int)this.Position.X, (int)this.Position.Y-100, 50, 100);
            

            if (velocity.X > 0)
            {
                if (enemy.Position.X > hitbox.X && enemy.Position.X <= hitbox.X + 100 &&
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            // Draw that sprite.
            //spriteBatch.Draw(redHitBox, hitbox, Color.Red);
